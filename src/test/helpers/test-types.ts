 ...
 */
export function getExcludePatternsDefault(
  props: Record<string, ConfigurationProperty>,
): string[] {
 ...
 */
export function getSortOrderDefault(
  props: Record<string, ConfigurationProperty>,
): string {
 ...
 */
export function getSortOrderEnum(
  props: Record<string, ConfigurationProperty>,
): string[] {
  const prop = props["commandtree.sortOrder"];
 ...
 */
export function getSortOrderEnumDescriptions(
  props: Record<string, ConfigurationProperty>,
): string[] {
  const prop = props["commandtree.sortOrder"];
